          ...
          <Table.Root variant="outline">
            <Table.Header>
              <Table.Row>
                ...
                <Table.ColumnHeader>Mockup</Table.ColumnHeader>
            ...
            <Table.Body>
              {projects.map((project) => (
                <Table.Row key={project.id}>
                  ...
                  <Table.Cell>{project.company_name}</Table.Cell>
            ...
            <VStack gap={4} align="stretch">
              <HStack gap={4} align="start">
                ...
                <Field.Root flex="1">
                  ...
                  <ImageUpload
                    ...
                    onImageUpload={(url) => handleInputChange('company_logo_url', url)}
                    onImageDelete={() => handleInputChange('company_logo_url', '')}
              ...
              <Field.Root>
                ...
                <ImageUpload
                  ...
                  onImageUpload={(url) => handleInputChange('mockup_url', url)}
